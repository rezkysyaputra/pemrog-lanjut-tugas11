...
namespace PerpustakaanAppMVC.View
{
    ...
    {
        // deklarasi objek collection untuk menampung onjek mahasiswa
        ...
        private void btnTambah_Click(object sender, EventArgs e)
        {
            ...
            FrmEntryMahasiswa frmEntry = new FrmEntryMahasiswa("Tambah Mahasiswa", controller);
        ...
        private void btnPerbaiki_Click(object sender, EventArgs e)
        {
            if (lvwMahasiswa.SelectedItems.Count > 0)
            {
                ...
                // buat objek form entry data mahasiswa
                FrmEntryMahasiswa frmEntry = new FrmEntryMahasiswa("Edit Mahasiswa", mhs, controller);
        ...
        private void btnHapus_Click(object sender, EventArgs e) {
            if (lvwMahasiswa.SelectedItems.Count > 0)
            {
                var konfirmasi = MessageBox.Show("Apakah data mahasiswa dihapus ? ", "Konfirmasi",
        ...
        private void TampilkanDataKeListView(List<Mahasiswa> dataMahasiswa)
        {
            ...
            {
                var noUrurt = lvwMahasiswa.Items.Count + 1;
                var item = new ListViewItem(noUrurt.ToString());
                item.SubItems.Add(mhs.Npm);
                item.SubItems.Add(mhs.Nama);
                item.SubItems.Add(mhs.Angkatan);
        ...
        {
                string cariNama = txtNama.Text.Trim().ToLower();

                // Filter nama by name
               var filteredMahasiswa = listOfMahasiswa.Where(mhs => mhs.Nama.ToLower().Contains(cariNama)).ToList();
